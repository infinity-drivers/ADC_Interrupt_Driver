...
void GPIO_Init(uint16_t pin, GPIO_TypeDef* port, uint32_t mode, uint32_t freq);
...
void adc_on(bool mode){
	...
	GPIO_Init(GPIO_PIN_0, GPIOA, GPIO_MODE_ANALOG, GPIO_SPEED_FREQ_HIGH);
	GPIO_Init(GPIO_PIN_2, GPIOA, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_FREQ_LOW);
	GPIO_Init(GPIO_PIN_10, GPIOA, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_FREQ_LOW);
	GPIO_Init(GPIO_PIN_5, GPIOB, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_FREQ_LOW);
	GPIO_Init(GPIO_PIN_10, GPIOB, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_FREQ_LOW);
	GPIO_Init(GPIO_PIN_9, GPIOA, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_FREQ_LOW);
	GPIO_Init(GPIO_PIN_7, GPIOC, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_FREQ_LOW);
	GPIO_Init(GPIO_PIN_6, GPIOB, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_FREQ_LOW);
	GPIO_Init(GPIO_PIN_7, GPIOA, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_FREQ_LOW);
	GPIO_Init(GPIO_PIN_6, GPIOA, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_FREQ_LOW);
	GPIO_Init(GPIO_PIN_5, GPIOA, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_FREQ_LOW);
	GPIO_Init(GPIO_PIN_9, GPIOB, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_FREQ_LOW);
	GPIO_Init(GPIO_PIN_8, GPIOB, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_FREQ_LOW);
